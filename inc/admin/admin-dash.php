...
/**
 * DashWidgets
 * Class that removes existing widgets and adds/creates new ones.
 *
    ...
    public function welcome(){
      ...
      <article class="widget">
        <footer class="widget__footer box__footer">
          <h1>Hello Chaun.</h1>
          <p>Shall we play a <a href="https://player.vimeo.com/video/45196609?&autoplay=1" target="_blank">game?</a></p>
        </footer>
      </article>
      <?php
    }
    ...
    public function admin_links() {
      ...
      <article class="widget box">
        <div class="widget__content box__content">
          ...
          <hr class="sep">
          <p><i class="dashicons-before dashicons-testimonial"></i>  <a class="" href="edit.php?post_type=work_cta">Manage Work CTAs</a> | <a class="" href="post-new.php?post_type=work_Cta">Create a Work CTA</a></p>
        </div>
